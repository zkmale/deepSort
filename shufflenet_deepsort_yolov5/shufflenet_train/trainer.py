...
if __name__=="__main__":
    ...
    train_path = r"D:/datasets/sort_people/Market-1501-v15.09.15/pytorch/train_all"            # 数据集存放信息
    test_path = r"D:/datasets/sort_people/Market-1501-v15.09.15/pytorch/val"
